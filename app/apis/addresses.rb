class Addresses < Grape::API
  ...
  resource 'addresses' do
    ...
    # curl -H 'Accept: application/json' -X POST -d '{"store_id": "1","address":{"address1":"31 Ricketts Street","address2":"De Tyger","suburb_id":"1","city":"cape town","zipcode":"7500","country":"South Africa","latitude":"-33.960905","longitude":"18.470102"}}'  http://127.0.0.1:9000/api/v1/addresses/get_delivery_price -v
