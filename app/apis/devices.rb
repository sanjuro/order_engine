class Devices < Grape::API
  ...
  resource 'devices' do
    ...
    # curl -i -H "Accept: application/json" -X POST -d '{"authentication_token": "AXSSSSED2ASDASD2","device":{"device_type":"android", "device_identifier":"103edb7d8c4e3669", "device_token": "APA91bFgMkYWLlF68P9OkC8YhE7dPHjDWYWrRJDAolkSa19CS1jZ_79GkkAwfq3QWIimpKI0Otkf_u89vVkZdFH0tlXkoKdusvR7RazE7pbTx-mt_UWfg-URY_ebS7hlCS2SYpIH9tj1uAzMLAH_zoA6bZ6bJ9TOpQ"}}' http://127.0.0.1:9000/api/v1/devices/register
