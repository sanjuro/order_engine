class Stores < Grape::API
  ...
  resource 'stores' do
    ...
    # curl -H 'Accept: application/json' -X POST -d '{"authentication_token": "CXTTTTED2ASDBSD4", "query_term": "kauai", "latitude": "-33.92947", "longitude": "18.41071"}' 'http://127.0.0.1:9000/api/v1/stores/search' -H Content-Type:application/json -v
