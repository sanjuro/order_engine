class Orders < Grape::API
  ...
  resource 'orders' do
    ...
    # curl -i -H "Accept: application/json" -X POST -d '{"authentication_token":"CXTTTTED2ASDBSD4", "time_to_ready": "15"}' http://107.22.211.58:9000/api/v1/orders/10/in_progress -v 
    ...
    post "/:id/in_progress" do 
      ...
      if order.device_type.eql?('andriod')
