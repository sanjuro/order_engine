class Orders < Grape::API
  ...
  resource 'orders' do
    ...
    # curl -i -X POST -d '{"authentication_token":"54ec660cd621f87dcc9a76c0a33285d1","order":{"unique_id":"sim0000001", "special_instructions":"I would like my Burrito on wholeweat", "device_identifier": "DEfe123123", "device_type": "blackberry", "line_items":[{"variant_id":"1","quantity":"1"}]}}' http://107.22.211.58:9000/api/v1/orders -v
