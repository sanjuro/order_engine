...
class Order < ActiveRecord::Base
  ...
  def send_new_order_notification
    ...
    Resque.enqueue(NotificationAndroidSender, "APA91bH92GqItwXK3_cq_wdb27tlTNK1kixILAC9H9T2XCHm_uvZQtWJDtsGNX7mewe1tCr4A2As3ZXzMwMZYP2KFQNIIJ6dH3U-eX5ypz9Nd_Yo3I6GkmfNECXBexCRtMmCdKpeYtxe", self.id, message)
  ...
  def format_with_store_for_web_serivce
    ...
    orders_return = { 
            ...
            "store_order_number" => self.store_order_number,
            "store_image" => !self.store.nil? ? self.store.store_icon : vosto_store.store_icon,
            "is_delivery" => self.is_delivery,
            "delivery_total" => self.ship_total,
            "total" => self.total,
            "updated_at" => self.updated_at,
